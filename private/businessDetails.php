...
// </details>
//
function ciniki_businesses_businessDetails($ciniki, $business_id) {
    ...
    if( !isset($rc['business']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.businesses.9', 'msg'=>'Unable to get business details'));
    }

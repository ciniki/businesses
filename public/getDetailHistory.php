...
function ciniki_businesses_getDetailHistory($ciniki) {
	...
	if( $args['field'] == 'business.name' ) {
		return ciniki_core_dbGetChangeLog($ciniki, $args['business_id'], 'businesses', '', 'name', 'businesses');
	} elseif( $args['field'] == 'business.tagline' ) {
		return ciniki_core_dbGetChangeLog($ciniki, $args['business_id'], 'businesses', '', 'tagline', 'businesses');
	}

	return ciniki_core_dbGetChangeLog($ciniki, $args['business_id'], 'business_details', $args['field'], 'detail_value', 'businesses');
}
?>

...
function ciniki_businesses_backupDownload($ciniki) {
	...
	if( !preg_match("/^backup-[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9].zip$/", $args['backup_id']) ) {
		...
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1735', 'msg'=>'Invalid backup file'));
	}
	...
	if( !is_file($backup_file) ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1735', 'msg'=>'Backup does not exist'));
	}

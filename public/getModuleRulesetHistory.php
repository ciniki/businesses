...
//  </users>
//
function ciniki_tenants_getModuleRulesetHistory($ciniki) {
    //
    ...
    $ac = ciniki_tenants_checkAccess($ciniki, $args['tnid'], 'ciniki.tenants.getModuleRulesetHistory');
    if( $ac['stat'] != 'ok' ) {
        return $ac;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.tenants', 'ciniki_tenant_history', $args['tnid'], 
        'ciniki_tenant_modules', $args['field'], 'ruleset');
}
?>

...
//	</users>
//
function ciniki_businesses_getModuleRulesetHistory($ciniki) {
	//
	...
	return ciniki_core_dbGetChangeLog($ciniki, $args['business_id'], 'ciniki_business_modules', $args['field'], 'ruleset', 'businesses');
}
?>

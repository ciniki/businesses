...
//
function ciniki_businesses_settingsAPIsUpdate($ciniki) {
    //
    ...
    $ac = ciniki_businesses_checkAccess($ciniki, $args['business_id'], 'ciniki.businesses.settingsAPIsUpdate');
    if( $ac['stat'] != 'ok' ) {
        return $ac;
    }
    ...
    ciniki_core_loadMethod($ciniki, 'ciniki', 'businesses', 'public', 'settingsAPIsGet');
    return ciniki_businesses_settingsAPIsGet($ciniki);
}
?>

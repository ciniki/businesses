...
//
function ciniki_tenants_settingsAPIsUpdate($ciniki) {
    //
    ...
    $ac = ciniki_tenants_checkAccess($ciniki, $args['tnid'], 'ciniki.tenants.settingsAPIsUpdate');
    if( $ac['stat'] != 'ok' ) {
        return $ac;
    }
    ...
    ciniki_core_loadMethod($ciniki, 'ciniki', 'tenants', 'public', 'settingsAPIsGet');
    return ciniki_tenants_settingsAPIsGet($ciniki);
}
?>
